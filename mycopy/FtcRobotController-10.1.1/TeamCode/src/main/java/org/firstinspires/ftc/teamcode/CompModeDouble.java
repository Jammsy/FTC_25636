...
import static org.firstinspires.ftc.teamcode.CompModeDouble.ledStates.*;
...
@TeleOp(name = "CompModeDouble", group = "Iterative Opmode")
public class CompModeDouble extends OpMode {
